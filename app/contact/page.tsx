                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
                            ...
                            <div className="space-y-5">
                                {[
                                    ...
                                    { icon: 'M15 10.5a3 3 0 11-6 0 3 3 0 016 0z M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z', label: 'Office', value: '112 - 828 Harbourside Drive, North Vancouver, BC V7P 3R9' },
                                ].map((item) => (
